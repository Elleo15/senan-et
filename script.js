...
const translations = {
  az: {
    ...
    meat_beef: "Dana əti",
    meat_ribs: "Qabırğa",
    meat_bone: "Sümüklü ət",
    meat_master: "Usta qəssab",
    meat_cut: "Kəsim",
    meat_fresh2: "Tər ət",
    meat_order2: "Sifariş hazır",
    meat_raw: "Çiy ət",
    meat_variety: "Geniş çeşid",
    meat_back: "Arxa hissə",
  ...
  ru: {
    ...
    gallery_desc:
      "Каждый кусок мяса готовится профессиональными руками с любовью.",
    meat_lamb: "Баранина",
    meat_beef: "Говядина",
    meat_ribs: "Рёбрышки",
    meat_bone: "Мясо на кости",
    meat_master: "Мастер-мясник",
    meat_cut: "Нарезка",
    meat_fresh2: "Свежее мясо",
    meat_order2: "Заказ готов",
    meat_raw: "Сырое мясо",
    meat_variety: "Широкий выбор",
    meat_back: "Задняя часть",
    order_tag: "Предзаказ",
  ...
  en: {
    ...
    meat_beef: "Beef",
    meat_ribs: "Ribs",
    meat_bone: "Bone-in Meat",
    meat_master: "Master Butcher",
    meat_cut: "Cutting",
    meat_fresh2: "Fresh Meat",
    meat_order2: "Order Ready",
    meat_raw: "Raw Cuts",
    meat_variety: "Wide Variety",
    meat_back: "Rear Cut",
    order_tag: "Pre-Order",
